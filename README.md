...
Sprint 4.7 immutable verification passed `634/634` against its V4 source, but Sprint 4.8 supersedes that candidate contract. Production Contract V4 is a superseded candidate / historical pre-approval artifact. The prior Sprint 4.8 source `06e0d6e2c9c9138a73ebe69bbdd1766c813d5f89` and evidence commit `eebbd169aeff6afaeeaba75c1c120d823e2ec2b3` remain immutable superseded failed-audit history. Phase B10.1 corrective source `e56e51e72dc5fd9ee47d847781a545134b092059` is technically source-frozen; immutable verification passed 934/934 twice with identical signature `11631338912972649069`, and the frozen exporter suite passed 73/73. The current reproducible evidence package binds those results to source tree `c97ba3cf8b21d12cc601753f4b2c311a06d02206` and verification-source digest `66a11100c3ba44a6c3b0699b93dedfacd3c2d0d618ddcc4b039efe0beda4cfd7`. Production Contract V5 remains Candidate / In Review and unlocked, Sprint 4 remains the authorized baseline, and a final independent merge audit is required. No runtime authorization, production-readiness claim, merge authorization, formal approval, or Architecture Lock is granted.
