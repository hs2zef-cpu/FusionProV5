...
Sprint 4.7 immutable verification passed `634/634` against its V4 source, but Sprint 4.8 supersedes that candidate contract. Production Contract V4 is a superseded candidate / historical pre-approval artifact. The prior Sprint 4.8 source/evidence pair `06e0d6e2c9c9138a73ebe69bbdd1766c813d5f89` / `eebbd169aeff6afaeeaba75c1c120d823e2ec2b3` and the later B10.1 pair `e56e51e72dc5fd9ee47d847781a545134b092059` / `b6b36f204d4ebeb3aab4fdacf31b0b8b5b8e1b91` remain immutable superseded failed-final-audit history. Phase B11 source `b9b175a5226dd85c3eaacc86c2daca2a42f24b01` and its immutable D3 runs are superseded development history after evidence generation exposed overly literal terminal-build and server-record parsers. Phase B11.2 is the current uncommitted Candidate / In Review correction on top of B11.1: build identity resolves from explicit MetaTester authority with consistent optional agent/login corroboration, and server identity resolves from allowlisted structured tester generation or legacy execution records with source-bound symbol/timeframe and Trial/Demo checks. Its 107-case exporter suite and exact unchanged D3 Generate path pass offline. It is not source-frozen and has no final repository evidence. Production Contract V5 remains unlocked, Sprint 4 remains the authorized baseline, and no runtime authorization, production-readiness claim, merge authorization, formal approval, or Architecture Lock is granted.
