...
//| NOT FOR PRODUCTION                                               |
//| NO BROKER ACCESS                                                 |
//| Sprint 4.4 deterministic semantic contract verification.        |
//+------------------------------------------------------------------+
#property strict
...
int OnInit()
{
   Print("SWV5_RUN_METADATA suite=SPRINT4.4 fixture_account_mode=HEDGING fixture_broker=TEST-BROKER fixture_server=TEST-SERVER broker_access=false");
