//+------------------------------------------------------------------+
//| SOMWANG_XAU_M15_FUSION_PRO_V5_SPRINT3_1.mq5                     |
//| Sprint 3.1 diagnostics and dashboard hardening.                  |
...
int OnInit()
{
   ...
   {
      Print("SOMWANG FUSION V5 Sprint 3.1 init failed: invalid input parameters");
   ...
   if(!ok)
   {
      Print("SOMWANG FUSION V5 Sprint 3.1 init failed: initialization error");
      return INIT_FAILED;
   }

   g_dashboard.Configure("SWV5_S31_DASH_", InpPanelCorner, InpPanelX, InpPanelY,
   ...
   IndicatorSetString(INDICATOR_SHORTNAME, "SOMWANG XAU M15 FUSION PRO V5 SPRINT 3.1");
