//+------------------------------------------------------------------+
//| SOMWANG_XAU_M15_FUSION_PRO_V5_SPRINT2_2.mq5                     |
//| Sprint 2.2 configurable read-only dashboard.                     |
...
int OnInit()
{
   ...
   {
      Print("SOMWANG FUSION V5 Sprint 2.2 init failed: invalid input parameters");
   ...
   if(!ok)
   {
      Print("SOMWANG FUSION V5 Sprint 2.2 init failed: indicator cache initialization error");
      return INIT_FAILED;
   }

   g_dashboard.Configure("SWV5_S22_DASH_", InpPanelCorner, InpPanelX, InpPanelY,
   ...
   IndicatorSetString(INDICATOR_SHORTNAME, "SOMWANG XAU M15 FUSION PRO V5 SPRINT 2.2");
