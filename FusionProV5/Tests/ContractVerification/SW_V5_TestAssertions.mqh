...
public:
   ...
   {
      return StringFormat("{\"schema\":\"SWV5-CONTRACT-TEST-RESULT-V1\",\"contract_policy\":\"SWV5-PRODUCTION-V2\",\"total\":%d,\"passed\":%d,\"failed\":%d,\"skipped\":%d,\"signature\":\"%I64u\",\"deterministic\":%s}",
