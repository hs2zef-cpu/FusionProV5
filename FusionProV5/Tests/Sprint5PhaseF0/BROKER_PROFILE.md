...
**BUILD-6180 CLIENT-LOCAL REJECTION OBSERVED — BROKER BEHAVIOR NOT PROFILED.**
...
| Server/local time | Six post-materialization samples; local minus server = +25,200 seconds in all samples |
