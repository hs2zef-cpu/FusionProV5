...
| F0-NEG-01 | authoritative negative side-effect proof | DEMO REQUIRED | NOT PROVEN after client-local rejection; zero rows/callback absence remain non-authoritative |
