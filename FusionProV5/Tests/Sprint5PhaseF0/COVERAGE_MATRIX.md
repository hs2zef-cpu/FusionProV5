...
| Durable pre-send correlation | `CORRELATION_IDENTITY_DESIGN.md`, NC-14 | RUN-SCOPED comment/Magic/ticket linkage observed; durable authoritative carrier still unproven |
...
| Query incomplete differs from empty | query profile, NC-05/13 | OBSERVED ON DEMO; positive rows observed, but every query remains `UNPROVEN` |
