...
#define SWV5S5_SCHEMA_VERSION 1
#define SWV5S5_MINIMUM_COMPATIBLE_VERSION 1
#define SWV5S5_POLICY_ID "SWV5-SPRINT5-PHASE-B-V1"
...
enum SWV5S5_RequestSequenceDisposition
{
   ...
   SWV5S5_SEQUENCE_RESERVED_NEW=1,
   SWV5S5_SEQUENCE_EXISTING_IDEMPOTENT=2,
   SWV5S5_SEQUENCE_STALE_REVISION=3,
   SWV5S5_SEQUENCE_STALE_OWNER=4,
   SWV5S5_SEQUENCE_CONFLICT=5
};

enum SWV5S5_PublicationDisposition
{
   SWV5S5_PUBLICATION_INVALID=0,
   SWV5S5_PUBLICATION_ELIGIBLE=1,
   SWV5S5_PUBLICATION_STALE_REVISION=2,
   SWV5S5_PUBLICATION_STALE_OWNER=3,
   SWV5S5_PUBLICATION_INTEGRITY_FAILURE=4,
   SWV5S5_PUBLICATION_CONFLICT=5
};
...
enum SWV5S5_ClaimDisposition
{
   ...
   SWV5S5_CLAIM_GRANTED_NOW=1,
   SWV5S5_CLAIM_ALREADY_CLAIMED=2,
   SWV5S5_CLAIM_EXPIRED=3,
   SWV5S5_CLAIM_STALE_OWNER=4,
   SWV5S5_CLAIM_CONFLICT=5,
   SWV5S5_CLAIM_SNAPSHOT_MISMATCH=6,
   SWV5S5_CLAIM_PERMIT_MISMATCH=7,
   SWV5S5_CLAIM_TIME_INVALID=8
};
